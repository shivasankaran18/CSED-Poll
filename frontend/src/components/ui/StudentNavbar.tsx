      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex-shrink-0 flex items-center">
            ...
            <span className="ml-2 text-xl font-bold text-purple-800">Student Polls</span>
          </Link>
          ...
          <div className="hidden sm:flex sm:items-center">
            <Button
              ...
              className="text-purple-600 hover:text-purple-800 hover:bg-purple-100 transition-colors duration-200"
            >
          ...
          <div className="sm:hidden">
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              <SheetTrigger asChild>
                <Button variant="ghost" size="icon" className="text-purple-600 hover:text-purple-800 focus:outline-none">
              ...
              <SheetContent side="right" className="w-[280px] sm:hidden">
                <SheetHeader className="border-b border-gray-200 px-6 py-4 mb-4">
                  <SheetTitle className="text-purple-800">Menu</SheetTitle>
                </SheetHeader>
                <div className="px-6">
                      ...
                      <Link
                        ...
                        className={`block py-2 rounded-md text-base font-medium transition-colors duration-200 ${
                          location.pathname === route.path
                            ? 'bg-purple-100 text-purple-600 px-4'
